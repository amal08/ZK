...
public class CopyOfServices {
     ...
     */
    public void StartEnroll(Variant UserID, Variant FingerID, Variant Flag) {
        System.out.println("start enroll...");
        // System.out.println("OnEnrollFinger registred = " + Dispatch.call(zk, "RegEvent", 1, 8).toBoolean());
        System.out.println(Dispatch.call(zk, "StartEnrollEx", UserID, FingerID, Flag));

        // System.out.println("ReadRTLog read = " + Dispatch.call(zk, "ReadRTLog", 1).toBoolean());
        // System.out.println("GetRTLog read = " + Dispatch.call(zk, "GetRTLog", 1).toBoolean());
    ...
    public void Set_User(Variant dwEnrollNumber, Variant Name, Variant Password, Variant Privilege, Variant Enabled) {
        ...
        boolean isUserAdded = Dispatch.call(zk, "SSR_SetUserInfo", dwMachineNumber, dwEnrollNumber, Name, Password, Privilege, Enabled).getBoolean();
